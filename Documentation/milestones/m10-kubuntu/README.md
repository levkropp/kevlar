# Milestone 10: Kubuntu Desktop Integration

**Goal:** Run a modern desktop environment (Kubuntu 24.04) with graphical
interface, window manager, and user applications.

**Current state:** M9 provides systemd-based headless OS. M10 adds GPU support,
...
### M10a: Display Server (Wayland or X11)
...
### M10b: Desktop Environment (KDE Plasma)
