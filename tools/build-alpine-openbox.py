...
def write_kevlar_config(root: Path) -> None:
    ...
    (xorg_conf_dir / "10-fbdev.conf").write_text(
        ...
        '    # ShadowFB on (default).  Was previously forced "off" while\n'
        '    # libshadow looped infinitely on Kevlar (task #42 / blog 243-244).\n'
        '    # Root cause was arm64 fb pages mapped Device-nGnRnE; LDP/STP\n'
        '    # in musl memcpy is implementation-defined there.  Now using\n'
        '    # Normal-NC (task #44), matching Linux fbdev behavior.\n'
        'EndSection\n'
        '\n'
        'Section "Screen"\n'
        '    Identifier "default"\n'
