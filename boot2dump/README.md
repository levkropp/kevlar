...
- A **sufficiently large** file for the crash log (e.g. in the following example, `kevlar.dump`)
...
```
$ dd if=/dev/zero of=/kevlar.dump bs=1024 count=64
```
...
void your_panic_handler(void) {
    ...
    entry("kevlar.dump", log, sizeof(log));
